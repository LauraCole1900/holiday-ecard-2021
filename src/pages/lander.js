      ...
      <Container fluid>
        ...
        <Row className="story">
          <Col sm={{ span: 8, offset: 2 }}>
            <p>Winter had come.</p>
            <p>{chosenWords[0]} sat back in {chosenWords[0] === "Mrs. Claus" || chosenWords[0] === "Clara" || chosenWords[0] === "Sugar Plum Fairy" ? "her" : "his"} {chosenWords[1]} {chosenWords[2]} {chosenWords[3]} and {chosenWords[4]} {chosenWords[0] === "Mrs. Claus" || chosenWords[0] === "Clara" || chosenWords[0] === "Sugar Plum Fairy" ? "her" : "his"} {chosenWords[5]}. A {chosenWords[6]} {chosenWords[7]} in the fireplace, warming the room; {chosenWords[8]} {chosenWords[9]} on the {chosenWords[10]} at the window, casting a {chosenWords[11]} {chosenWords[12]} on the snow outside. From outside, {chosenWords[13]} {chosenWords[14]} in the barn where {chosenWords[15]} {chosenWords[16]} the {chosenWords[17]}, {chosenWords[18]} the {chosenWords[19]}, and {chosenWords[20]} the {chosenWords[21]}, readying them for their run in just a few nights’ time. The smell of {chosenWords[22]} {chosenWords[23]} through the room, and a mug of {chosenWords[24]} {chosenWords[25]} at {chosenWords[0] === "Mrs. Claus" || chosenWords[0] === "Clara" || chosenWords[0] === "Sugar Plum Fairy" ? "her" : "his"} elbow.</p>
            ...
            <p>{chosenWords[0]} {chosenWords[30]} and {chosenWords[31]} {chosenWords[0] === "Mrs. Claus" || chosenWords[0] === "Clara" || chosenWords[0] === "Sugar Plum Fairy" ? "her" : "his"} way to the window. {chosenWords[32]} had been at work, drawing {chosenWords[32] === "Mrs. Claus" || chosenWords[32] === "Clara" || chosenWords[32] === "Sugar Plum Fairy" ? "her" : "his"} {chosenWords[33]} {chosenWords[34]} across the glass. In the distance, the moon was just past full. It was a {chosenWords[35]} {chosenWords[36]}.</p>
          </Col>
        </Row>
        <Row>
          <Col sm={{ span: 8, offset: 2 }}>
