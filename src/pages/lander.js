...
const Lander = () => {
  ...
  const verbs = ["crackled", "cackled", "sparkled", "checked", "ran", "flew", "froze", "melted", "slid", "crunched", "said", "asked", "fell", "built", "tapped", "hung", "decorated", "baked", "made", "mixed", "drifted", "drove", "dove", "dripped", "burned", "twinkled", "fought", "clashed", "jingled", "rang", "sang", "broke", "shattered", "was", "stubbed", "slipped", "cleaned", "opened", "closed", "started", "stopped", "rolled", "grew", "moved", "raked", "shoveled", "jumped", "surfed", "hurtled", "sat", "walked", "ran", "wound", "popped", "levered", "searched", "snowed", "dug", "laughed", "chuckled", "froze", "melted", "solidified", "thawed", "examined", "entered", "exited", "lifted", "hopped", "wafted", "smiled", "stood"];
